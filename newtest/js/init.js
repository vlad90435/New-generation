...
(function (w, $) {
  w.Snap.plugin(function (Snap, Element, Paper, global) {
    Element.prototype.polyAnimate = function (
      destPoints,
      duration,
      easing,
      callback
  ...
  if ($("html").hasClass("index")) {
    ...
    function nextStroke() {
      ...
      new w.TimelineMax()
        .staggerTo("#introAnim" + nextStrokeIndex, 0.3, {
          autoAlpha: 1,
          ease: Power3.easeIn,
        })
        ...
        .add(
          TweenMax.staggerTo(
            "#introAnim" + nextStrokeIndex + " .PLines",
            0.5,
            {
              strokeDashoffset: 0,
              delay: 0.1,
        ...
        .add(
          TweenMax.staggerTo(
            "#introAnim" + nextStrokeIndex + " .SLines",
            0.2,
            {
              strokeDashoffset: 0,
              delay: 0.1,
...
!(function (e, t, n) {
  ...
  function l(e, t) {
    if ("object" == typeof e) for (var n in e) B(e, n) && l(n, e[n]);
    else {
      e = e.toLowerCase();
      var r = e.split("."),
        i = Modernizr[r[0]];
  ...
  function d(e, n, r, i) {
    ...
    if (parseInt(r, 10))
      for (; r--; )
        (l = s("div")), (l.id = i ? i[r] : f + (r + 1)), d.appendChild(l);
    return (
      (o = s("style")),
      (o.type = "text/css"),
      (o.id = "s" + f),
  ...
  function p(e, t, n) {
    ...
    for (var o in e)
      if (e[o] in t)
        return n === !1
          ? e[o]
          : ((i = t[e[o]]), r(i, "function") ? c(i, n || t) : i);
    return !1;
  }
  ...
  function h(t, r) {
    ...
    if ("CSS" in e && "supports" in e.CSS) {
      for (; i--; ) if (e.CSS.supports(v(t[i]), r)) return !0;
      return !1;
    }
    if ("CSSSupportsRule" in e) {
      for (var o = []; i--; ) o.push("(" + v(t[i]) + ":" + r + ")");
      return (
        (o = o.join(" or ")),
        d(
  ...
  function g(e, t, i, o) {
    ...
    for (
      var A, d, c, p, v, g = ["modernizr", "tspan", "samp"];
      !D.style && g.length;

    )
      (A = !0), (D.modElem = s(g.shift())), (D.style = D.modElem.style);
    for (c = e.length, d = 0; c > d; d++)
      if (
        ...
        if (o || r(i, "undefined")) return a(), "pfx" == t ? p : !0;
        try {
          D.style[p] = i;
        } catch (m) {}
        if (D.style[p] != v) return a(), "pfx" == t ? p : !0;
      }
    return a(), !1;
  }
  ...
  Modernizr._q.unshift(function () {
    ...
    Modernizr.addTest("cssfilters", function () {
      ...
      var e = s("a");
      return (
        (e.style.cssText = x.join("filter:blur(2px); ")),
  ...
  var M = (_.prefixed = function (e, t, n) {
    return 0 === e.indexOf("@")
      ? Q(e)
      : (-1 != e.indexOf("-") && (e = u(e)), t ? m(e, t, n) : m(e, "pfx"));
  });
  Modernizr.addTest("forcetouch", function () {
    return b(M("mouseforcewillbegin", e, !1), e)
