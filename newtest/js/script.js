  ...
  if ($("html").hasClass("index")) {
    ...
    function convertToPS() {
      for (var b = 0; b < polysInSVG; b++) {
        purpleFrontPolys[b].polyAnimate(
          PSLogoPoints[b],
          3000,
          mina.easeOutCubic,
          function () {}
        );
        purpleBackPolys[b].polyAnimate(
          PSLogoPoints[15 - b],
          3000,
          mina.easeOutCubic,
          function () {}
        );
        greenFrontPolys[b].polyAnimate(
          PSLogoPoints[b],
          3000,
          mina.easeOutCubic,
          function () {}
        );
        greenBackPolys[b].polyAnimate(
          PSLogoPoints[15 - b],
          3000,
          mina.easeOutCubic,
          function () {}
        );
        yellowFrontPolys[b].polyAnimate(
          PSLogoPoints[b],
          3000,
          mina.easeOutCubic,
          function () {}
        );
        yellowBackPolys[b].polyAnimate(
          PSLogoPoints[15 - b],
          3000,
          mina.easeOutCubic,
          function () {}
    ...
    function defineAnimThings() {
      new TimelineMax()
        ...
        .addCallback(convertPSToIcosa, 3, ["convertPSToIcosa"])
...
(function (w) {
  ...
  w.$ani.visits = {
    ...
    initTitle:
      "Prashant Sani: Front-end Web Developer | HTML5, CSS3, SVG , Scroll Websites| PSD to HTML | Coaching & Training",
    initObj: {
      page: "index",
      title: "index",
      type: "index",
